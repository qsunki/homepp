          ...
          <ul className="flex space-x-4">
            <li className="relative group">
              <a
                ...
                aria-label="LinkedIn"
                className="relative flex items-center justify-center w-12 h-12 bg-white text-gray-800 rounded-full shadow-lg overflow-hidden transition-all duration-500 ease-in-out group-hover:text-white"
              >
                <div className="absolute inset-0 w-full h-full bg-[#0274b3] transition-all duration-500 ease-in-out transform origin-bottom scale-y-0 group-hover:scale-y-100"></div>
                <svg
              ...
              <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 px-2 py-1 text-xs text-white bg-gray-700 rounded opacity-0 group-hover:opacity-100">
                LinkedIn
              </div>
            </li>
            <li className="relative group">
              <a
                ...
                className="relative flex items-center justify-center w-12 h-12 bg-white text-gray-800 rounded-full shadow-lg overflow-hidden transition-all duration-500 ease-in-out group-hover:text-white"
              >
                <div className="absolute inset-0 w-full h-full bg-[#24262a] transition-all duration-500 ease-in-out transform origin-bottom scale-y-0 group-hover:scale-y-100"></div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <li className="relative group">
              <a
                ...
                className="relative flex items-center justify-center w-12 h-12 bg-white text-gray-800 rounded-full shadow-lg overflow-hidden transition-all duration-500 ease-in-out group-hover:text-white"
              >
                <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-[#405de6] via-[#c135b4] to-[#fd1d1d] transition-all duration-500 ease-in-out transform origin-bottom scale-y-0 group-hover:scale-y-100"></div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <li className="relative group">
              <a
                ...
                className="relative flex items-center justify-center w-12 h-12 bg-white text-gray-800 rounded-full shadow-lg overflow-hidden transition-all duration-500 ease-in-out group-hover:text-white"
              >
                <div className="absolute inset-0 w-full h-full bg-[#ff0000] transition-all duration-500 ease-in-out transform origin-bottom scale-y-0 group-hover:scale-y-100"></div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  fill="currentColor"
                  className="bi bi-youtube relative z-10"
                  viewBox="0 0 16 16"
                >
                  <path
