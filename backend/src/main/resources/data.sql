...
INSERT INTO `VIDEO` (`video_id`, `record_start_at`, `url`, `length`, `thumbnail_url`, `cam_id`)
VALUES (1, '2023-07-29 10:00:00', 'http://example.com/video1.mp4', 120, 'http://example.com/thumb1.jpg', 1),
...
VALUES (1, '2023-07-29 10:00:00', 'INVASION', 1, 1),
       ...
       (4, '2023-07-29 13:00:00', 'CUSTOM', 2, 3),
