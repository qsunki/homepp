...
public class ShareController {
    ...
    public ShareDto createShare(@AuthenticationPrincipal MemberInfoDto memberInfoDto, @RequestBody ShareDto shareDto) {
        return shareService.createShare(memberInfoDto.getEmail(), shareDto.getEmail(), shareDto.getNickname());
    }
    ...
    public ShareDto updateShare(
        ...
        return shareService.updateShare(memberInfoDto.getEmail(), sharedMemberEmail, shareDto.getNickname());
    }
