...
global cnt_record, max_cnt_record, on_record, is_detected, is_record, start_record, is_capture, is_stream, is_system_on
is_system_on = False
is_stream = False
on_record = False
is_record = False
...
schedule.every(10).seconds.do(thumbnail_capture)
